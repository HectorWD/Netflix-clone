          ...
          <div className='h-[600px] max-w-[450px] mx-auto text-white bg-black/75'>
            <div className='max-w-[320px] mx-auto py-16'>
              ...
              <form
                ...
                value={pass}
                className='p-3 my-2 bg-gray-700 rounded'/>
                <button className='px-1 py-2 my-6 font-bold bg-red-500 rounded'>Sign Up</button>
                <div className='flex items-center justify-between text-sm text-slate-500'>
                  <p><input type={'checkbox'} className='mr-2 rounded'/>Remember me</p>
                  <p>Need help</p>
                </div>
                <p className='py-8'>
                  <span className='text-slate-500'>Already subscribed to Netflix?</span> {' '}
                  <Link href={'/Login'}><a className='hover:underline'>Sign In</a></Link>
                </p>
              </form>
            </div>
          </div>
